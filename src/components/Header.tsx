      ...
      <nav className="container-custom">
        <div className="flex items-center justify-between h-20">
          ...
          >
            ...
            <div className="relative text-2xl md:text-3xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent">
              Portfolio
            </div>
          </motion.div>
          ...
          <div className="hidden md:flex items-center space-x-2">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="ml-4 px-6 py-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
            >
              Liên hệ ngay
            </motion.button>
          </div>
              ...
              <div className="container-custom py-6">
                  ...
                  {menuItems.map((item) => {
                    ...
                    return (
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        onClick={() => scrollToSection(item.href)}
                        className={`group relative w-full flex items-center justify-between px-6 py-4 rounded-xl font-medium transition-all duration-300 ${
                          isActive
                            ? "text-white bg-gradient-to-r from-blue-500 to-purple-600 shadow-lg"
                            : "text-gray-700 hover:text-blue-600 hover:bg-blue-50/50"
                        }`}
                ...
                >
                  <motion.button
                    ...
                    className="w-full py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl font-semibold shadow-lg flex items-center justify-center gap-2"
                  >
